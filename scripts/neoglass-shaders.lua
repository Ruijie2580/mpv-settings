...
-- Toggleable shader building blocks for uosc menu entries.
-- Adds FSRCNNX, RAVU, NVScaler/NVSharpen, KrigBilateral, CAS,
-- SSimDownscaler, SSimSuperRes, AdaptiveSharpen, plus the Anime4K pack.
...
local shaders = {
    -- === Upscalers (luma / chroma pre-scalers) ===
    ...
    ravu_r3_yuv     = {file = 'RAVU_r3_yuv.glsl',          label = 'RAVU_r3_yuv.glsl'},
    ravu_r4_yuv     = {file = 'RAVU_r4_yuv.glsl',          label = 'RAVU_r4_yuv.glsl'},
    nvscaler        = {file = 'NVScaler.glsl',             label = 'NVScaler.glsl'},
    krig            = {file = 'KrigBilateral.glsl',        label = 'KrigBilateral.glsl (chroma)'},

    -- === Post-process / sharpen / SSIM ===
    adaptive_sharpen = {file = 'adaptive-sharpen.glsl',    label = 'adaptive-sharpen.glsl'},
    cas             = {file = 'CAS.glsl',                 label = 'CAS.glsl'},
    nvsharpen       = {file = 'NVSharpen.glsl',           label = 'NVSharpen.glsl'},
    ssim_sr         = {file = 'SSimSuperRes.glsl',        label = 'SSimSuperRes.glsl'},
    ssim_ds         = {file = 'SSimDownscaler.glsl',      label = 'SSimDownscaler.glsl (downscale)'},
...
local function set_preset(name)
    local preset = {
        ...
        -- New combined presets using community shaders.
        natural_krig    = {'fsrcnnx_8', 'krig'},
        upscale_ravu    = {'ravu_r4_yuv'},
        upscale_nis     = {'nvscaler', 'ssim_sr', 'nvsharpen'},
        natural_smooth  = {'fsrcnnx_8', 'adaptive_sharpen'},
    }
